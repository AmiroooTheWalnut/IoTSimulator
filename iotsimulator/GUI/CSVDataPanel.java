...
public class CSVDataPanel extends javax.swing.JPanel {
    ...
    public CSVDataPanel(MainFrame passed_parent) {
        ...
        jRadioButton9.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
                int selectedMetric = jList3.getSelectedIndex();
                if (selectedMetric > -1) {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Number of rows to show:");
        ...
        jRadioButton5.setText("Numeric");

        buttonGroup3.add(jRadioButton9);
        jRadioButton9.setText("Nominal");
    ...
    private void loadDataButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadDataButtonActionPerformed
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                int rowCount = Math.min(parent.iOTSimulator.metricManager.data.getRowCount(), (int) jSpinner1.getValue());
                int columnCount = parent.iOTSimulator.metricManager.data.getRow(0).getFieldCount();

                String data[][] = new String[rowCount][columnCount];

                for (int i = 0; i < rowCount; i++) {
                    for (int j = 0; j < columnCount; j++) {
                        data[i][j] = parent.iOTSimulator.metricManager.data.getRow(i).getField(j);
                    }
                }

                jTable1.setModel(new javax.swing.table.DefaultTableModel(data, columns.toArray()));
